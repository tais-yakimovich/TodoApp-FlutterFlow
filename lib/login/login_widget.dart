...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signUpConfirmedPasswordTextController ??= TextEditingController();
    _model.signUpConfirmedPasswordFocusNode ??= FocusNode();

    _model.logiTextController ??= TextEditingController();
    _model.logiFocusNode ??= FocusNode();
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .signUpConfirmedPasswordTextController,
                                          focusNode: _model
                                              .signUpConfirmedPasswordFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.done,
                                          obscureText: !_model
                                              .signUpConfirmedPasswordVisibility,
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelStyle:
                                                FlutterFlowTheme.of(context)
                                            ...
                                            suffixIcon: InkWell(
                                              ...
                                              focusNode: FocusNode(
                                                  skipTraversal: true),
                                              child: Icon(
                                                _model.signUpConfirmedPasswordVisibility
                                                    ? Icons.visibility_outlined
                                                    : Icons
                                                        .visibility_off_outlined,
                                                size: 24.0,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      SizedBox(
                                        width: double.infinity,
                                        child: TextFormField(
                                          controller: _model.logiTextController,
                                          focusNode: _model.logiFocusNode,
                                          autofocus: false,
                                          textInputAction: TextInputAction.next,
                                          obscureText: false,
                                          decoration: InputDecoration(
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              final user = await authManager.signInWithEmail(
                                context,
                                _model.logiTextController.text,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.signUpPasswordTextController.text !=
                                  _model.signUpConfirmedPasswordTextController
                                      .text) {
